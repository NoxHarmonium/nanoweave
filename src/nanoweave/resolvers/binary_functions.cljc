(ns nanoweave.resolvers.binary-functions
  (:require [nanoweave.ast.binary-functions #?@(:cljs [:refer [MapOp FilterOp ReduceOp RegexMatchOp RegexFindOp RegexSplitOp]])]
            [nanoweave.resolvers.base :refer [handle-bin-op]]
            [clojure.string :as str]
            [nanoweave.ast.base :refer [Resolvable]])
  #?(:clj (:import [nanoweave.ast.binary_functions MapOp FilterOp ReduceOp RegexMatchOp RegexFindOp RegexSplitOp])))
